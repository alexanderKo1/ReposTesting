...
namespace mantis_tests
{
    public class AdminHelper : HelperBase
    {
        ...
        public List<AccountData> GetAllAccounts()
        {
            ...
            IList<IWebElement> rows = driver.FindElements(By.CssSelector("div.widget-main tbody tr"));
        ...
        public void DeleteAccount(AccountData account)
        {
            ...
            driver.FindElement(By.CssSelector("form#manage-user-delete-form input[type='submit']")).Click();
